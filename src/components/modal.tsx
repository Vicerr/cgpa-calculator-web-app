...
export default function Modal({ initialIsOpen = false }: { initialIsOpen: boolean }) {
    ...
    return (
        <>
            <button onClick={toggleVisibility} className="py-3 px-4 rounded-md bg-gray-800 fixed bottom-10 right-10 cursor-pointer text-xs text-gray-100 font-semibold ">
                Upload Course
            </button>
